...
class ObjectCollectionHandler<T>: Handler {
    
    var onSuccess: ([T]?) -> Void = { (response) in  print("ObjectCollectionHandler::onSucess: \(String(describing: response))") }
